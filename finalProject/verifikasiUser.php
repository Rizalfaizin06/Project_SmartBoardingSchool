...
$_SESSION["currentPage"] = "verificationUser";
...
if (isset($_POST['buttonSetuju'])) {
    ...
    try {
        ...
        $sql = "UPDATE tbl_users SET `status` = '1' WHERE uuidUser = '$uuidUser'";
...
if (isset($_POST['buttonTolak'])) {
    ...
    // $uuidUser = $_POST['uuidUser'];
    // $query = "DELETE FROM tbl_users WHERE uuidUser = '$uuidUser'";
    // mysqli_query($koneksi, $query);
    // ______---_____ KURANG DI BAGIAN DETAIL USER ______---_____
}
    ...
    <div class="w-xl grid items-center justify-items-center ">
        <div class="grid grid-cols-1 gap-8 p-5 w-full max-w-xl">
            ...
            <div class=" w-full grid grid-cols-1 justify-items-center">
                ...
                <?php
                $logNotif = query("SELECT * FROM tbl_users WHERE status = 0");
                // var_dump($logNotif); ?>
