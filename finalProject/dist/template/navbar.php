      ...
      <ul class="space-y-2">
         ...
         <?php if ($role == 1): ?>
            <?php if ($_SESSION["currentPage"] == "verificationUser"): ?>
               <li>
                  <a href="verifikasiUser.php" data-drawer-toggle="default-sidebar"
                     class="flex items-center p-2 text-base font-normal rounded-lg bg-primary hover:bg-opacity-80">
                     <img src="assets/icons/identityWhite.png" alt="" class="w-6 h-6">
            ...
            <?php if ($_SESSION["currentPage"] == "verificationProduct"): ?>
               <li>
                  <a href="verifikasiProduk.php" data-drawer-toggle="default-sidebar"
                     class="flex items-center p-2 text-base font-normal rounded-lg bg-primary hover:bg-opacity-80">
                     <img src="assets/icons/verifikasiProdutWhite.png" alt="" class="w-6 h-6">
            ...
            <?php if ($_SESSION["currentPage"] == "listUser"): ?>
               <li>
                  <a href="listUser.php" data-drawer-toggle="default-sidebar"
                     class="flex items-center p-2 text-base font-normal rounded-lg bg-primary hover:bg-opacity-80">
                     <svg aria-hidden="true" class="flex-shrink-0 w-6 h-6 text-white transition duration-75"
                        fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                        <path fill-rule="evenodd" d="M10 9a3 3 0 100-6 3 3 0 000 6zm-7 9a7 7 0 1114 0H3z" clip-rule="evenodd">
         ...
         <?php if ($role == 2): ?>
            <?php if ($_SESSION["currentPage"] == "daftarMenu"): ?>
               <li>
                  <a href="daftarMenu.php" data-drawer-toggle="default-sidebar"
                     class="flex items-center p-2 text-base font-normal rounded-lg bg-primary hover:bg-opacity-80">
                     <svg aria-hidden="true" class="flex-shrink-0 w-6 h-6 text-white transition duration-75"
                        fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                        <path
                     ...
                     <span class="ml-3 font-poppins text-white whitespace-nowrap">Daftar Menu</span>
                  </a>
               </li>
            <?php else: ?>
               <li>
                  <a href="daftarMenu.php" data-drawer-toggle="default-sidebar"
                     ...
                     <span class="ml-3 whitespace-nowrap">Daftar Menu</span>
                  </a>
               </li>
            <?php endif; ?>
         ...
         <?php elseif ($role == 3 || $role == 4): ?>
            ...
            <?php if ($role == 3): ?>
               ...
               <?php endif; ?>
            <?php else: ?>
               <?php if ($_SESSION["currentPage"] == "setLimit"): ?>
                  <li>
                     <a href="setLimit.php" data-drawer-toggle="default-sidebar"
                        class="flex items-center p-2 text-base font-normal rounded-lg bg-primary hover:bg-opacity-80">
                        <img src="assets/icons/walletWhite.png" alt="" class="w-6 h-6">

                        <span class="ml-3 font-poppins text-white whitespace-nowrap">Set Limitasi</span>
               ...
               <?php else: ?>
                  <li>
                     <a href="setLimit.php" data-drawer-toggle="default-sidebar"
                        class="flex items-center p-2 text-base font-normal text-gray-900 rounded-lg">
                        <div class="relative">
                           <img src="assets/icons/walletGray.png" alt="" class="w-6 h-6">
                        </div>
                        <span class="ml-3 whitespace-nowrap">Set Limitasi</span>
                     </a>
                  </li>
               <?php endif; ?>
            <?php endif; ?>
            <?php if ($_SESSION["currentPage"] == "request"): ?>
               <li>
                  <a href="request.php" data-drawer-toggle="default-sidebar"
                     class="flex items-center p-2 text-base font-normal rounded-lg bg-primary hover:bg-opacity-80">
                     ...
                     <div class="relative">
                        ...
                        <?php
                        if ($role == 4):
                           $logNotif = query("SELECT COUNT(*) notif FROM tbl_notifikasi WHERE idUser = '$idAnak' AND statusNotif = 0")[0]['notif'];
                           if (!empty($logNotif)): ?>
                              <div
                     ...
                     <span class="ml-3 font-poppins text-white whitespace-nowrap">Request</span>
            ...
            <?php else: ?>
               <li>
                  <a href="request.php" data-drawer-toggle="default-sidebar"
                     class="flex items-center p-2 text-base font-normal text-gray-900 rounded-lg">
                     <div class="relative">
                        <svg aria-hidden="true" class="relative flex-shrink-0 w-6 h-6 text-gray-500 transition duration-75"
                           fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                           <path
                              d="M8.707 7.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l2-2a1 1 0 00-1.414-1.414L11 7.586V3a1 1 0 10-2 0v4.586l-.293-.293z">
                           </path>
                     ...
                     <span class="ml-3 whitespace-nowrap">Request</span>
                  </a>
               </li>
            <?php endif; ?>
         <?php endif; ?>
