...
$_SESSION["currentPage"] = "verificationProduct";
...
$menu = query("SELECT * FROM tbl_menu M, tbl_category C, tbl_users U WHERE M.idCategory = C.idCategory AND M.idPenjual = U.idUser ORDER BY realName, namaCategory, namaMenu;");

$category = query("SELECT * FROM tbl_category C, tbl_users U WHERE U.idUser = C.idUserCat ORDER BY realName, namaCategory");
// var_dump($menu);
...
<body>
    ...
    <div class="w-full grid grid-cols-1 items-center justify-items-center p-5">
        <div class="border-2 border-gray-300 rounded-xl shadow-2xl p-5 w-full max-w-4xl">
            <div>
