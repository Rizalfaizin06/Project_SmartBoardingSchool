...
<body>
    ...
    <h3><?= $oneView["idMenu"]; ?></h3>
        ...
        if(in_array($oneView["idMenu"], $pesanan)):?>
            ...
            <?php else:?>
            <button class="btn btn-outline-dark w-25" id="button-pesan" name="buttonPesan" onclick="orderMenu(<?= $oneView['idMenu']; ?>)">Pesan</button>
    ...
    function orderMenu(idMenu){
        $.ajax({
            url: "insertPesan.php",
            type: "post",
            data: {insertData: idMenu},
